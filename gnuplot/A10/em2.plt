...
set xr [-400:400]
#set auto xy
set title "Earth and Moon Orbit About Center of Mass, Vmoon at 10%"
...
plot 'emslow.dat' u ($2/scale):($3/scale) with lines lc 'dark-green' title 'Earth Orbit',\
	 'emslow.dat' u ($6/scale):($7/scale) with lines lc 'black' title 'Moon Orbit',\
